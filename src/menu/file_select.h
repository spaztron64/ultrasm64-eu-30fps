...
enum MenuButtonTypes {
    ...
    MENU_BUTTON_AA_OFF,
    MENU_BUTTON_AA_FAST,
    MENU_BUTTON_AA_FANCY,
    MENU_BUTTON_SCREEN_4_3,
    MENU_BUTTON_SCREEN_16_10,
    MENU_BUTTON_SCREEN_16_9,
    MENU_BUTTON_DEDITHER_OFF,
    MENU_BUTTON_DEDITHER_ON,
    MENU_BUTTON_FRAMECAP_OFF,
    MENU_BUTTON_FRAMECAP_ON,
